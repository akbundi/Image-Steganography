...
r.call('wm', 'iconphoto', r._w, PhotoImage(file="C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Icon.png"))
...
ImgBulb  = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Bulb.png"))
Bulb = Button(f,image = ImgBulb,borderwidth = 0 , bg = "White",command = Help)
Bulb.grid(row=0,column=0)

ImgBulb_  = ImageTk.PhotoImage(Image.open("C:/Users//HPWORLD/PycharmProjects/untitled3/AppImages/Bulb_.png"))
Bulb_ = Label(f,image = ImgBulb_,borderwidth = 0)
Bulb_.grid(row=0,column=1)


ImgIs  = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/IS.png"))
Lis = Label(f,image = ImgIs,borderwidth = 0)
Lis.grid(row=1,columnspan=2)

ImgInsert  = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Insert.png"))
Insert = Button(f,image = ImgInsert,borderwidth = 0 , bg = "White",command = Insert)
Insert.grid(row=2,columnspan=2)

ImgExtract  = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Extract.png"))
...
ImgI_back  = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Insert_Back.png"))
IBack = Button(fInsert,image = ImgI_back,borderwidth = 0 , bg = "White",command = BACK)
IBack.grid(row=0,column=0)

ImgI_back_bulb = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Insert_Back_Bulb.png"))
IBack_Bulb = Label(fInsert,image = ImgI_back_bulb,borderwidth = 0 , bg = "White")
IBack_Bulb.grid(row=0,column=1,columnspan=2)

ImgI_bulb  = ImageTk.PhotoImage(Image.open("C:/Users//HPWORLD/PycharmProjects/untitled3/AppImages//Insert_Bulb.png"))
IBulb = Button(fInsert,image = ImgI_bulb,borderwidth = 0 , bg = "White")
IBulb.grid(row=0,column=3)

ImgINSERT = ImageTk.PhotoImage(Image.open("C:/Users//HPWORLD//PycharmProjects/untitled3/AppImages/Insert_insert.png"))
IInsert = Label(fInsert,image = ImgINSERT,borderwidth = 0 , bg = "White")
IInsert.grid(row=1,columnspan=4,pady=(0,10))

ImgILoc = ImageTk.PhotoImage(Image.open("C:/Users//HPWORLD/PycharmProjects/untitled3/AppImages/Insert_img_loc.png"))
...
ImgIPlnTxt = ImageTk.PhotoImage(Image.open("C:/Users//HPWORLD//PycharmProjects//untitled3//AppImages//Insert_plain_text.png"))
IPlain = Label(fInsert,image = ImgIPlnTxt,borderwidth = 0 , bg = "White")
IPlain.grid(row=4,columnspan=2)

ImgITxtFile = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Insert_txt_loc.png"))
...
ImgIkey = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Insert_key.png"))
...
ImgNewImg = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Insert_New_Image.png"))
...
ImgIButton = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Insert_insert-button.png"))
...
ImgE_back  = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Extract_Back.png"))
EBack = Button(fExtract,image = ImgE_back,borderwidth = 0 , bg = "White",command = BACK)
EBack.grid(row=0,column=0)

ImgE_back_bulb = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Extract_Back_Bulb.png"))
EBack_Bulb = Label(fExtract,image = ImgE_back_bulb,borderwidth = 0 , bg = "White")
EBack_Bulb.grid(row=0,column=1,columnspan=2)

ImgE_bulb  = ImageTk.PhotoImage(Image.open("C://Users/HPWORLD/PycharmProjects/untitled3/AppImages/Extract_Bulb.png"))
EBulb = Button(fExtract,image = ImgE_bulb,borderwidth = 0 , bg = "White")
EBulb.grid(row=0,column=3)

ImgEXTRACT = ImageTk.PhotoImage(Image.open("C:/Users//HPWORLD/PycharmProjects/untitled3/AppImages/Extract_extract.png"))
EExtract = Label(fExtract,image = ImgEXTRACT,borderwidth = 0 , bg = "White")
EExtract.grid(row=1,columnspan=4,pady=(0,10))

ImgELoc = ImageTk.PhotoImage(Image.open("C://Users/HPWORLD/PycharmProjects/untitled3/AppImages/Extract_img_loc.png"))
...
ImgEkey = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Extract_key.png"))
...
ImgOption = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD/PycharmProjects/untitled3/AppImages/Extract_Option.png"))
...
ImgEButton = ImageTk.PhotoImage(Image.open("C:/Users/HPWORLD//PycharmProjects/untitled3/AppImages/Extract_extract_button.png"))
